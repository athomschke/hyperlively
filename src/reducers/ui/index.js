...
import { actionsActions, actions, type ACTIONS_ACTION } from 'src/reducers/ui/actions';
import { parametersActions, parameters, type PARAMETERS_ACTION } from 'src/reducers/ui/parameters';
import { interpretationsActions, interpretations, type INTERPRETATIONS_ACTION } from 'src/reducers/ui/interpretations';
import { drawing, drawingActions, type DRAWING_ACTION } from 'src/reducers/ui/drawing';
import { handwritingRecognition, handwritingRecognitionActions, type HANDWRITING_RECOGNITION_ACTION } from 'src/reducers/ui/handwritingRecognition';
import { observeMutations, observeMutationsActions } from 'src/reducers/ui/observeMutations';
import { showInterpreter, showInterpreterActions } from 'src/reducers/ui/showInterpreter';
import { type OBSERVE_MUTATIONS_ACTION } from 'src/actionTypeDefinitions';
import { ploma, plomaActions, type PLOMA_ACTION } from 'src/reducers/ui/ploma';
import { threshold, thresholdActions, type THRESHOLD_ACTION } from 'src/reducers/ui/threshold';
